    ...
    <div className="">
        ...
        <div className="container">
                ...
                <div className="col col-md-6">
                    ...
                    <div className="pt-3">
                        <p className="mb-2"><i class="bi bi-people-fill"></i><i class="bi bi-people-fill"></i>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatibus quia quos, ducimus neque vitae fugiat itaque culpa adipisci repudiandae facilis. Quibusdam quidem at dolorem deleniti omnis asperiores odio, nesciunt itaque!</p>
