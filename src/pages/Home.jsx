...
const Home = () => {
    return (
    <main>  
        <section className="img-fluid hero" id="text_background">
            ...
            <div className="sections row border rounded-1 shadow ">
                ...
                <article className="col col-md-6">
                    ...
                    <div className="html5 mb-3">
                        ...
                        <div className="progress mt-2">
                            <div className="progress-bar bg-success barphp" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                    </div>
                    <div className="html5 mb-3 ">
